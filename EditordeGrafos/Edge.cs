...
namespace EditordeGrafos{
    ...
    public class Edge{
        ...
        //Usada para identificar los tipos de aristas de arbol y de avance. 
        //  Nota personal: Posiblemente pueda usar este contrstructor para identificar todos los tipos de aristas en un recorrido
        public Edge(int peso, NodeP origin, NodeP destiny, string name, string arblName)
        {
            this.source = origin;
