...
namespace EditordeGrafos{
    ...
    public class NodeP{
        ...
        public int Depth; //Para saber la profundidad del nodo (Que cada nodo guarde su valor en profundo en un recorrido)
        public int numero_arbol; //Para saber de que numero raiz viene (Para encontrar las cruzadas)
        public char nRaiz;
