...
namespace EditordeGrafos
{
    public partial class Editor : Form
    {
        ...
        {
            //Agregamos la variable booleana para saber si es dirigido o no: edgeIsDirected
            muestramatriz frm = new muestramatriz(graph, edgeIsDirected);
            frm.ShowDialog();
        }
        ...
        */
        ...
        private void toolStripButton_GradoGrafos_Click(object sender, EventArgs e)
        {
            MuestraGradosGrafo Form_MuestraGrafosGrafo;
            Form_MuestraGrafosGrafo = new MuestraGradosGrafo(graph, edgeIsDirected);
            Form_MuestraGrafosGrafo.Show();
        }

        private void toolStripButton_DFS_Click(object sender, EventArgs e)
        {
            DepthFirstSearch Form_DFS;
            Form_DFS = new DepthFirstSearch(graph);  
            Form_DFS.Show();
        }
        ...
        {
            Prim Form_Prim;
            Form_Prim = new Prim(graph);
            Form_Prim.Show();
        }

        private void ArbolBPlus_Click(object sender, EventArgs e)
        {
            Form1 ArbolBPlus;
            ArbolBPlus = new Form1();
            ArbolBPlus.Show();
        }
